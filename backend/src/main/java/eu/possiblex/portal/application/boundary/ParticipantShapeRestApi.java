...
public interface ParticipantShapeRestApi {
    @Operation(summary = "Get the Gaia-X legal participant shape", tags = {
        ...
        @ApiResponse(content = @Content(schema = @Schema(description = "Gaia-X legal participant shape as JSON string"))) })
    ...
    @Operation(summary = "Get the Gaia-X legal registration number shape", tags = {
        ...
        @ApiResponse(content = @Content(schema = @Schema(description = "Gaia-X legal registration number shape as JSON string"))) })
    ...
    @Operation(summary = "Get the Possible-X participant extension shape", tags = {
        ...
        @ApiResponse(content = @Content(schema = @Schema(description = "Possible-X participant extension shape as JSON string"))) })
